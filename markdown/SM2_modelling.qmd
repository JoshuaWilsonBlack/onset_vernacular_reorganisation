...
ggsave(
  here('plots', 'figure7_normalised_vowel_spaces.tiff'),
...
ggsave(
  filename = here('plots', 'figure6_combined_smooths.tiff'),
  plot = combined_plot,
  width = 14,
  height = 10,
  dpi = 300
...
ggsave(
  here('plots', 'figure5_nofreq_preds.tiff'),
  plot = out_plot,
  width = 7,
  height = 5,
  dpi = 500
...
ggsave(
  here('plots', 'figure8_nofreq_storyteller.tiff'),
  plot = out_plot,
  width = 7,
  height = 5,
  dpi = 500
