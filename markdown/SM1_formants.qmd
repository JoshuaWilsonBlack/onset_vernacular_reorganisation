...
We use word frequency information derived from the [CHILDES](https://childes.talkbank.org/) corpus [@macwhinneyChildesProjectTools2000]. The script
...
We use data from: [@garveyApproachStudyChildren1979; @wellsLearningInteractionStudy1981; @gathercoleAcquisitionPresentPerfect1986; @fletcherNormalLanguageDevelopment1988; @sawyerPretendPlayImprovisation1997; @newmanInputUptakeMonths2016; @tommerdahlReliabilityMorphologicalAnalyses2014].
]
